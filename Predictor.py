...
def score_game(game_core, range_start=1, range_end=100, ranges_count=2):
    ...
    for number in random_array:
        count_ls.append(game_core(number, range_start, range_end,
                                  ranges_count))
...
for ranges_count in range(1, 101):
    ranges_and_tries.append((ranges_count,
        score_game(game_core_v3, range_end=100, ranges_count=ranges_count)))
